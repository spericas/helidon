...
/**
 * Class StreamingBodyPart.
 *
 * @author Santiago Pericas-Geertsen
 */
public class StreamingBodyPart implements Flow.Subscriber<MultiPartDataChunk>, Flow.Publisher<DataChunk> {

    private final StreamingMultiPart parent;
    ...
    StreamingBodyPart(final StreamingMultiPart parent) {
        if (parent == null) {
    ...
    static class BodyPartSubscription implements Flow.Subscription {
        ...
        private final StreamingMultiPart.BodyPartProcessor processor;
        ...
        BodyPartSubscription(final Flow.Subscription delegate,
                             final StreamingMultiPart.BodyPartProcessor processor) {
